...
import bgVideo from "../assets/videos/main3.mp4";
import newsign from "../assets/images/ui/newsign.webp";
...
import { fetchGitHubStats, formatStatValue } from "../services/githubService";
...
// Function to get items with dynamic GitHub stats
const getItems = (githubStats) => [
  {
    id: "github", label: "GITHUB", handle: "@ROHIT-POUL", href: "https://github.com/Rohit-Poul", icon: "💻", barIcon: icon1, bars: 3, newBars: [0], counts: ["PROFILE", "REPOS", "PROJECTS"],
    links: ["github.com/Rohit-Poul", "github.com/Rohit-Poul?tab=repositories", "github.com/Rohit-Poul"],
    stats: [
      { tag: "REPO", value: githubStats.repos, color: "#6e5494" },
      { tag: "STR",  value: githubStats.stars,  color: "#4078c0" },
    ],
  },
  {
    id: "linkedin", label: "LINKEDIN", handle: "@ROHIT-POUL", href: "https://www.linkedin.com/in/rohit-poul-403a41289", icon: "🔗", barIcon: icon2, bars: 1, newBars: [0], counts: ["PROFILE"],
    links: ["linkedin.com/in/rohit-poul-403a41289"],
    stats: [
      { tag: "CON", value: "50+", color: "#0077b5" },
      { tag: "PST", value: "10+", color: "#00a0dc" },
    ],
  },
  {
    id: "email", label: "EMAIL", handle: "POULROHIT258@GMAIL.COM", href: "mailto:poulrohit258@gmail.com", icon: "📧", barIcon: icon3, bars: 1, newBars: [0], counts: ["CONTACT"],
    links: ["mail.google.com/mail/?view=cm&to=poulrohit258@gmail.com"],
    stats: [
      { tag: "RES", value: "<24H", color: "#34a853" },
      { tag: "AVL", value: "YES",  color: "#ea4335" },
    ],
  },
];
...
export default function Socials() {
  ...
  const [githubStats, setGithubStats]     = useState({ repos: "10+", stars: "5+" });
  ...
  useEffect(() => {
    async function loadGitHubStats() {
      ...
      setGithubStats({
        repos: formatStatValue(stats.repos),
        stars: formatStatValue(stats.stars),
      });
    }
    loadGitHubStats();
  }, []);

  const ITEMS = getItems(githubStats);
